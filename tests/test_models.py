...
class TestProductModel(unittest.TestCase):
    ...
    def test_find_by_name(self):
        ...
        expected_count = len([p for p in products if p.name == name_to_find])
    ...
    def test_find_by_category(self):
        ...
        expected_count = len([p for p in products if p.category == category_to_find])
    ...
    def test_find_by_availability(self):
        ...
        available_to_find = products[0].available
        expected_count = len([p for p in products if p.available == available_to_find])

        found_products = Product.find_by_availability(available_to_find)
        self.assertEqual(len(found_products), expected_count)
        for product in found_products:
            self.assertEqual(product.available, available_to_find)
